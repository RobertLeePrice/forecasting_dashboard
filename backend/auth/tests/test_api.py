...
#     def setUp(self):
#         User.objects.get_or_create(title='title1', slug='slug1')
#         User.objects.get_or_create(title='title2', slug='slug2')

#         self.create_read_url = reverse('flavors:flavor_rest_api')

#         self.read_update_delete_url = reverse('flavors:flavor_rest_api', k{'slug':
#     ,→ 'slug1'})
#     def test_list(self):
