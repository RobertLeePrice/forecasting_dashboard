...
function HomeScreen() {
  ...
  return (
    <>
      ...
      <div class="flex h-screen overflow-y-hidden bg-gray-900 min-h-screen justify-center">
        <div class="flex-1 flex flex-col lg:space-y-0 lg:flex-row">
          {/* <!-- Navigation --> */}
          <div class="bg-gray-700 px-2 py-2 lg:py-10 sm:rounded-xl flex lg:flex-col justify-between">
